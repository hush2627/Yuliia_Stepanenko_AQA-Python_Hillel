...
#FIXED VARIANT
indexes = [6, 10, 13]
all_people_equal_or_older_thirties = True
for index in indexes:
    if people_records[index][2] < 30:
        all_people_equal_or_older_thirties = False
print("all people in the list have age >=30 : " ,all_people_equal_or_older_thirties)
